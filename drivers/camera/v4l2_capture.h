...
#define V4L2_BUF_COUNT      4           /* DMA缓冲区数量 (i.MX6ULL内存受限) */
#define V4L2_DEVICE         "/dev/video0"

/* 支持的分辨率与格式 (OV5640典型输出) */
typedef enum {
    CAM_FMT_UYVY = V4L2_PIX_FMT_UYVY,   /* YUV422 (推荐，直接编码) */
    CAM_FMT_YUYV = V4L2_PIX_FMT_YUYV,   /* YUV422 */
    CAM_FMT_RGB565 = V4L2_PIX_FMT_RGB565, /* LCD预览用 */
    CAM_FMT_MJPEG = V4L2_PIX_FMT_MJPEG  /* 若摄像头支持硬件JPEG */
} camera_format_t;
